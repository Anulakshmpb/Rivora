...
export default function SideBar() {
    ...
    return (
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 lg:z-20 flex flex-col w-72 bg-white border-r border-slate-100 p-6 h-full transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="mb-10 px-2 flex justify-between items-start">
                    ...
                    <button
                        onClick={() => setIsOpen(false)}
                        className="lg:hidden p-1.5 hover:bg-slate-100 rounded-lg text-slate-400 hover:text-slate-900 transition-colors"
