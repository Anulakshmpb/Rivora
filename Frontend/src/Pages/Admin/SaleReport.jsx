            ...
            <main className="flex-1 lg:ml-72 bg-slate-50 min-h-screen pb-20">
                ...
                <div className="p-8 max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        {activeTab === 'products' && (
                            <>
                                <StatCard title="Total Products" value={filteredProducts.length} icon={Package} colorClass={{ bg: 'bg-indigo-500', text: 'text-indigo-500' }} />
                                <StatCard title="In Stock" value={filteredProducts.filter(p => p.quantity > 20).length} icon={AlertCircle} colorClass={{ bg: 'bg-amber-500', text: 'text-amber-500' }} />
                                <StatCard title="Low Stock" value={filteredProducts.filter(p => p.quantity > 0 && p.quantity <= 20).length} icon={AlertCircle} colorClass={{ bg: 'bg-yellow-500', text: 'text-yellow-500' }} />
                        ...
                        {activeTab === 'orders' && (
                            <>
                                ...
                                <StatCard title="Return Orders" value={filteredOrders.filter(o => o.orderStatus === 'Returned').length} icon={Activity} colorClass={{ bg: 'bg-orange-700', text: 'text-orange-700' }} />
                            </>
                        )}
                        {activeTab === 'customers' && (
                            <>
