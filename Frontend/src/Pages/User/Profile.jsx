            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-4">
                        ...
                        {/* Invite Card moved here for desktop */}
                        <div className="hidden lg:block bg-white rounded-3xl p-8 shadow-md relative overflow-hidden group hover:shadow-lg transition-shadow border border-gray-100">
                            ...
                            <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                                Earn up to <span className="font-bold text-indigo-600">$100</span> for every friend who joins.
                            </p>
                        </div>
                    </div>
                                    ...
                                    {isAddingAddress ? (
                                        <form onSubmit={handleAddAddress} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 mb-6">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                                ...
                                                <div className="md:col-span-2">
                                                    <input type="text" name="apartment" value={newAddress.apartment} onChange={handleAddressChange} placeholder="Apartment, suite, etc. (optional)" className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all placeholder-gray-400 bg-white" />
                                                </div>
                                                <div>
                                            ...
                                            {safeAddresses.map((addr, idx) => (
                                                <div key={idx} className="border border-gray-200 rounded-2xl p-5 relative group hover:border-indigo-200 transition-colors">
                                                    ...
                                                    <div className="flex items-start mb-2">
                                                        ...
                                                        <div>
                                                            <p className="text-sm font-semibold text-gray-900">{addr.street}{addr.apartment ? `, ${addr.apartment}` : ''}</p>
