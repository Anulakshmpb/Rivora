            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="fixed bottom-20 sm:bottom-24 right-4 sm:right-6 left-4 sm:left-auto w-[calc(100vw-2rem)] sm:w-96 h-[calc(100vh-7.5rem)] sm:h-[32rem] max-h-[32rem] bg-white/90 backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden z-50 flex flex-col border border-neutral-200"
                    >
