            ...
            <div className="flex w-full flex-col items-center justify-center bg-white p-6 sm:p-8 lg:w-1/2">
                <div className="w-full max-w-lg space-y-6">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        ...
                        className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-2 sm:px-3 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 transition-all active:scale-[0.98]">
